...
function plotGraph(procId){	
	...
	var titles = [procIdDisplayName + " - Memory", procIdDisplayName + " - Classes", procIdDisplayName + " - Threads", procIdDisplayName + 
					" - Compilation", procIdDisplayName + " - Garbage Collectors", procIdDisplayName + " - Memory Pool"];
